...
| 4 | Guest User Object (#EXT#) | <img src="./Screenshots/guest-user.png" width="180" style="border-radius:6px;"/> |
| 5 | Customer User Flow Creation | <img src="./Screenshots/user-flow.png" width="180" style="border-radius:6px;"/> |
